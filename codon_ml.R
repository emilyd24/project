...
#This code extracts LIFESPAN values from the continuous data
...
#Read in the continuous data and extract the species names from the list 
...
#Create dataframe of branches, this will be used for the lifespan vector 
...
#Calculate the vector lifespan, each entry of which is the average lifespan for the two nodes at either end of each branch
  ...
  setup = function(beta_0,beta_1,kappa,treefile, seqfile) {
    ...
    ### Changing code to allow omega to depend on the model
